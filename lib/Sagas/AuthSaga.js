...
exports.default = function (api) {
  var _marked = [attemptLogin, attemptGetMe, attemptLogout, attemptForgotPassword, attemptResetPassword, attemptUpdatePassword, attemptSignup, watchGetMe, watchLoginAttempt, watchLogoutAttempt, watchForgotPasswordAttempt, watchResetPasswordAttempt, watchUpdatePasswordAttempt, watchSignupAttempt].map(_regenerator2.default.mark);
    ...
    return _regenerator2.default.wrap(function attemptSignup$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            _context7.next = 2;
            return (0, _effects.call)(api.signup, { email: meta.username, password: meta.password });
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          ...
          case 3:
            ...
            _meta = _ref2.meta;
            _context9.next = 7;
            return (0, _effects.call)(attemptLogin, _meta);
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          ...
          case 3:
            ...
            _meta2 = _ref3.meta;
            _context10.next = 7;
            return (0, _effects.call)(attemptLogout, _meta2);
      ...
      while (1) {
        switch (_context11.prev = _context11.next) {
          ...
          case 3:
            ...
            _meta3 = _ref4.meta;
            _context11.next = 7;
            return (0, _effects.call)(attemptForgotPassword, _meta3);
      ...
      while (1) {
        switch (_context12.prev = _context12.next) {
          ...
          case 3:
            ...
            _meta4 = _ref5.meta;
            _context12.next = 7;
            return (0, _effects.call)(attemptResetPassword, _meta4);
      ...
      while (1) {
        switch (_context13.prev = _context13.next) {
          ...
          case 3:
            ...
            _meta5 = _ref6.meta;
            _context13.next = 7;
            return (0, _effects.call)(attemptUpdatePassword, _meta5);
      ...
      while (1) {
        switch (_context14.prev = _context14.next) {
          ...
          case 3:
            ...
            _meta6 = _ref7.meta;
            _context14.next = 7;
            return (0, _effects.call)(attemptSignup, _meta6);
